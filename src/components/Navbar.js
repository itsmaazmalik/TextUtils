    ...
    <div className="container-fluid">
      ...
      <div className="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <div className="form-check form-switch">
          <input className="form-check-input" onClick={props.toggleMode} type="checkbox"id="switchMode"/>
          <label className="form-check-label" htmlFor="switchMode">{props.mode}</label>
        </div>
        {/* </div> */}
      </div>
    </nav>
